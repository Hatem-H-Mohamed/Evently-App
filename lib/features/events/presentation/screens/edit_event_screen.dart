...
class _EditEventScreenState extends State<EditEventScreen> {
  ...
  @override
  void initState() {
    context.read<CreateEventCubit>().changeCatImage(widget.imageId!);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        leading: IconButton(
          icon: Icon(Icons.arrow_back, color: AppColorCommon.primary),
          onPressed: () {
          ...
          child: Column(
            children: [
              ...
              Padding(
                ...
                child: CatTaps(tapIndex: 1, mySelectedIndex: widget.imageId),
              ),
              Padding(
                padding: const EdgeInsets.all(16.0),
                child: Column(
